...
save(formation_model_c,file="3) Estimating the Models/Fitted Models/formation_model_c_2y.RData")
...
save(formation_model,file="3) Estimating the Models/Fitted Models/formation_model_2y.RData")
...
dissolution_model_c<-bam(d_response_~
                         ...
                         +d_military_ex_j
                         ,family=binomial(link = "logit"),discrete=TRUE,nthreads=20)
save(dissolution_model_c,file="3) Estimating the Models/Fitted Models/dissolution_model_c_2y.RData")
...
dissolution_model<-bam(d_response_~
                       ...
                       ,family=binomial(link = "logit"),discrete=TRUE,nthreads=20)
save(dissolution_model,file="3) Estimating the Models/Fitted Models/dissolution_model_2y.RData")
