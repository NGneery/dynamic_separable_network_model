...
save(formation_model_c,file="3) Estimating the Models/Fitted Models/formation_model_c.RData")
...
save(formation_model,file="3) Estimating the Models/Fitted Models/formation_model.RData")
...
save(dissolution_model_c,file="3) Estimating the Models/Fitted Models/dissolution_model_c.RData")
...
dissolution_model<-bam(d_response_~
                       ...
                       ,family=binomial(link = "logit"),discrete=TRUE,nthreads=20)
save(dissolution_model,file="3) Estimating the Models/Fitted Models/dissolution_model.RData")
